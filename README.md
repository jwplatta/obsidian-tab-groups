...
1. Download the latest release assets (`main.js`, `manifest.json`, `styles.css`) from the [Releases](https://github.com/jwplatta/tab-groups/releases) page.
2. Copy them to your vault at `.obsidian/plugins/tab-groups/`.
